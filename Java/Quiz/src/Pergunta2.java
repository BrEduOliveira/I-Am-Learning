...
public class Pergunta2 extends JFrame implements ActionListener{
	...
	ImageIcon imagem = new ImageIcon(getClass().getResource("/Imagens/pergunta2.png"));
	...
	public Pergunta2() {
		...
		texto.setFont(fonte);
		texto.setText("2 - Qual estrutura de dados em que o último elemento");
		add(texto);
		
		texto1.setBounds(20,45,500,20);
		texto1.setFont(fonte);
		texto1.setText("que entra é o primeiro que sai, ou seja, é LIFO(last-in, first-out)?");
		add(texto1);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==escolhas[3]) {
			...
			pergunta3.setAlternativas("Bubblesort","Buckersort","Quicksort","Radixsort");
		}else {
